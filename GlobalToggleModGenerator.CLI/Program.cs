...
using GlobalToggleModGenerator;
using GlobalToggleModGenerator.Model.Penumbra;

// Redirected file paths
const string HEAD_PATH = "common\\1\\c0101e0279_met.mdl";
const string BODY_PATH = "common\\2\\c0201e0001_top.mdl";
const string HAND_PATH = "common\\3\\c0201e0001_glv.mdl";
const string LEGS_PATH = "common\\4\\c0201e0001_dwn.mdl";
const string FEET_PATH = "common\\5\\c0201e0001_sho.mdl";
